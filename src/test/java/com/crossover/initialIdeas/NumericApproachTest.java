...
public class NumericApproachTest {

	private NumericApproach cross =  new NumericApproach();
	...
	public void executionStressTest(){
	    ...
	    System.out.println(elapsedTime +" ---> NumericApproach execution time wtih a 10000 loop");
	}
}
