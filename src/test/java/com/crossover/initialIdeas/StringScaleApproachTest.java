...
public class StringScaleApproachTest {

	private StringScaleApproach cross =  new StringScaleApproach();
	...
	public void executionStressTest()  throws CaseNotContemplatedException{
	    ...
	    System.out.println(elapsedTime +" ---> StringScaleApproach execution time wtih a 10000 loop");
	}
